			...
			<SelectPrimitive.Root {...props}>
				<div className="formSelect__wrapper">
					<SelectPrimitive.Trigger
						...
						className={`
							formSelect__trigger
							${hasError ? "formSelect__trigger--error" : ""}
							${isLoading ? "formSelect__trigger--loading" : ""}
						`}
					>
						{customValues ? (
						...
						<span
							className={`formSelect__placeholder ${props.value ? "formSelect__placeholder--active" : ""}`}
						>
							{placeholder}
						</span>
						<SelectPrimitive.Icon className="formSelect__icon">
							{isLoading ? (
								<Spinner />
							) : (
					...
					{hasError && (
						<p role="alert" className="formSelect__error">
							{error}
						</p>
					)}
				</div>
				...
				>
					...
					>
						{useSearch && (
							<div className="formSelect__header">
								<form className="search__form" onSubmit={() => {}}>
									<Input
										isSmall
										label=""
										type="text"
						...
						<SelectPrimitive.Viewport className="formSelect__viewport">
							{useSearch ? (
								<>
...
export const SelectItem = forwardRef<SelectItemRef, SelectItemProps>(
	({ children, ...props }, forwardedRef) => {
		return (
			<SelectPrimitive.Item {...props} ref={forwardedRef} className="formSelect__item">
