...
export const FormTableProductSelect = forwardRef<Ref, Props>(
	(
		{ id, type, error, value, disabled, usedProductIds, placeholder = "Select", onValueChange, template },
		forwardedRef,
	) => {
						...
						<div className="customTableSelect__items">
							{filteredValues.map((option) => (
								<button
									...
									key={option.id}
									disabled={usedProductIds?.includes(option.id)}
									className={`
