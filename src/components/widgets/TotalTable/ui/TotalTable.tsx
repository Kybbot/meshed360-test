...
type Props = {
	...
	serviceLinesValues: (OrderServiceLineType | AdditionalLineFormType)[];
};
...
export const TotalTable: FC<Props> = ({
	...
	const orderLines = useMemo(() => {
		return calculateTotalTableValues(orderLinesValues, taxInclusive);
	}, [orderLinesValues, taxInclusive]);
	const serviceLines = useMemo(() => {
		return calculateTotalTableValues(serviceLinesValues, taxInclusive);
