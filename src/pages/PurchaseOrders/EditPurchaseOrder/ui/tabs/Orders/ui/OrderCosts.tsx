...
import { OrderCostsRow } from "./OrderCostsRow";
...
import { DefaultCostLine, OrderLinesFormValues } from "@/@types/purchaseOrder/orderLines";
...
export const OrderCosts: FC<Props> = ({ errors, control, orderData, lineStatus, register, setValue }) => {
	...
	const colSpan = useMemo(() => {
		...
		if (trackingCategoryA || trackingCategoryB) return 10;
		return 9;
	}, [userAndOrgInfo]);
	...
	return (
		<TF>
			...
			{lineStatus !== "AUTHORISED" && (
				<>
					<TFAddRow>
						<Button type="button" isSecondary onClick={() => append(DefaultCostLine)}>
