...
import { BillAdditionalCostFormType, BillLineFormType } from "@/@types/purchaseOrders";
...
export const calculateFooterValues = (data: (BillLineFormType | BillAdditionalCostFormType)[]) => {
...
export const calculateTotalTableValues = (
	data: (BillLineFormType | BillAdditionalCostFormType)[],
	taxInclusive: boolean,
) => {
	return data.reduce(
		(prev, curr) => {
