...
import { OrderLines } from "@/pages/Orders/EditOrder/ui/tabs/Invoicing/templates/MeatTable/OrderLines.tsx";
import { OrderServices } from "@/pages/Orders/EditOrder/ui/tabs/Invoicing/templates/MeatTable/OrderServices.tsx";
		...
		if (creditNote) {
			form.reset({
				lines: creditNote?.lines.length
					? creditNote?.lines.map((line): MeatOrderLineType => {
							return {
