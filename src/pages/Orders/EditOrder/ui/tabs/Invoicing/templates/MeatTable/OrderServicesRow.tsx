...
import { Control, Controller, UseFieldArrayRemove, useFormContext, useWatch } from "react-hook-form";
...
export const OrderServicesRow: FC<Props> = ({ index, control, remove, priceListContentData, orderInfo }) => {
	const {
		setValue,
		register,
