...
import { useGetAllOrders } from "../api/queries/useGetAllOrders";
...
const Orders: FC = () => {
	...
	const { data, error, isLoading, isError, isSuccess } = useGetAllOrders({
		...
		<CommonPage>
			<div className="main__container">
				{isLoading ? (
					...
					<>
						<CommonPageHeader>
							<CommonPageTitle>Sales Orders</CommonPageTitle>
							<CommonPageActions>
								<Search
									id="searchId"
									name="search"
								...
								/>
								<Link to="/sales/orders/new" className="link">
