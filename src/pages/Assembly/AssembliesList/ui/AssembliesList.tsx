...
import { useAssembliesListTable } from "../hooks/useAssembliesListTable";
...
import { useGetAssembliesList } from "@/entities/assembly";

import { useDebounce } from "@/hooks/useDebounce";

const AssembliesList: FC = () => {
	...
	const { data, error, isLoading, isError, isSuccess } = useGetAssembliesList({
		searchValue,
		...
		<CommonPage>
			<div className="main__container">
				{isLoading ? (
					...
					<>
						<CommonPageHeader>
							<CommonPageTitle>Assemblies</CommonPageTitle>
							<CommonPageActions>
								<Search
									id="searchId"
									name="search"
								...
								/>
								<Link to="/production/assembly/new" className="link">
