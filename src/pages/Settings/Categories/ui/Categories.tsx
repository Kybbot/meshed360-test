...
import { useGetAllCategories } from "../api/queries/useGetAllCategories";
...
const Categories: FC = () => {
	...
	const { data, error, isLoading, isError, isSuccess } = useGetAllCategories({
			...
			<div className="main__container">
				<CommonPageWrapper>
					{isLoading ? (
						...
						<>
							<CommonPageHeader>
								<CommonPageTitle>Categories</CommonPageTitle>
								<CommonPageActions>
									<Search
										id="searchId"
										name="search"
