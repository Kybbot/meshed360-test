...
import { useUpdateCarrier } from "../api/mutations/useUpdateCarrier";
...
export const EditDialog: FC<EditDialogProps> = ({
	...
	const { isPending, isSuccess, isError, error, mutate } = useUpdateCarrier();
			...
			<DialogContent onInteractOutside={handleCloseModal} onEscapeKeyDown={handleCloseModal}>
				<div className="commonDialog">
					<div className="commonDialog__header">
						<DialogTitle asChild>
							<h3 className="commonDialog__title">Edit Carrier</h3>
						</DialogTitle>
					</div>
