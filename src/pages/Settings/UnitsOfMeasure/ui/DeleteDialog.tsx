...
import { useDeleteUnitOfMeasure } from "../api/mutations/useDeleteUnitOfMeasure";
...
export const DeleteDialog: FC<DeleteDialogProps> = ({
	...
	const { mutate, error, isError, isPending, isSuccess } = useDeleteUnitOfMeasure();
	...
	const handleOnSubmit = () => {
		if (currentItem.id && orgId) {
			mutate({ unitOfMeasureId: currentItem.id, organisationId: orgId });
		}
	};
		...
		<DialogRoot open={dialogState} onOpenChange={setDialogState}>
			<DialogContent size="small" onInteractOutside={handleCloseModal} onEscapeKeyDown={handleCloseModal}>
				<div className="infoDialog">
					...
					<DialogTitle asChild>
						<h3 className="infoDialog__title">Delete Unit of Measure</h3>
					</DialogTitle>
